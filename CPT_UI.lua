...
CPTab:Button({Title="Reset", Callback=function()
    ...
    clearRegionBox(); P.deactivatePaste()
...
CPTab:Button({Title="Delete Zone", Callback=function()
    ...
    local minB=Vector3.new(math.min(S.cpCorner1.X,S.cpCorner2.X)-2.4, math.min(S.cpCorner1.Y,S.cpCorner2.Y)-2.4, math.min(S.cpCorner1.Z,S.cpCorner2.Z)-2.4)
    local maxB=Vector3.new(math.max(S.cpCorner1.X,S.cpCorner2.X)+2.4, math.max(S.cpCorner1.Y,S.cpCorner2.Y)+2.4, math.max(S.cpCorner1.Z,S.cpCorner2.Z)+2.4)
    local toDelete={}
